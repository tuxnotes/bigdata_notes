...
if __name__ == '__main__':
    ...
    # 上面load中的参数的格式跟文件系统的格式是一样的，并没有使用hdfs://...这种格式。这里的格式也是可以通过--master yarn
    # 即可以使用./spark-submit --master yarn /path/to/air_quality.py这种方式
    # 但需设置环境变量HADOOP_CONF_DIR or YARN_CONF_DIR，如export HADOOP_CONF_DIR=XXX;./spark-submit --master yarn /path/to/air_quality
